...
import pynndescentSC.sparse  as sparse
import pynndescentSC.sparse_nndescent as sparse_nnd
import pynndescentSC.distances as pynnd_dist
...
class NNDescent:
    ...
    def _init_sparse_search_function(self):
        ...
        from .distances import alternative_dot, alternative_cosine
